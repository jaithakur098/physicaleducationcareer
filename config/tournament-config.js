/* ============================================================================
   ALWAR CUP CHAMPIONSHIP — Tournament Configuration
   ...
   Pure config file — safe to include on any page. Does NOT touch existing code.
   ============================================================================ */
(function (root) {
  'use strict';
  ...
  root.TOURNAMENT_DEFAULTS = {
    moduleName: 'ALWAR CUP CHAMPIONSHIP',
    ...
    collections: {
      ...
      /* NOTE: the exam system already owns a top-level 'certificates' collection.
         Tournament certificates therefore live in 't_certificates' so the
         existing exam certificates are never touched. */
