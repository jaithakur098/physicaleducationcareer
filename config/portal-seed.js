...
(function (root) {
  ...
  add({ type:'article', category:'govt-jobs', topic:'sports-quota-jobs',
  ...
  add({ type:'scholarship', category:'scholarships', topic:'sports-scholarships',
  ...
  add({ type:'article', category:'scholarships', topic:'scholarship-application-guide',
  ...
  add({ type:'previous-paper', category:'previous-papers', topic:'bped-previous-papers',
  ...
  add({ type:'previous-paper', category:'previous-papers', topic:'sample-papers',
  ...
  /* ===================== 9. Online Tests ===================== */
  add({ type:'test', category:'online-tests', topic:'physical-education-mock-test',
  ...
  add({ type:'test', category:'online-tests', topic:'cbse-pe-test',
  ...
  add({ type:'test', category:'online-tests', topic:'teacher-exam-test',
  ...
  /* ===================== 10. Student News ===================== */
  add({ type:'news', category:'student-news', topic:'education-news',
  ...
  add({ type:'news', category:'student-news', topic:'result-news',
  ...
  add({ type:'news', category:'student-news', topic:'admission-news',
  ...
  add({ type:'news', category:'student-news', topic:'recruitment-news',
  ...
  add({ type:'article', category:'career-guidance', topic:'defence-career',
    title:'Defence Career After 12th — NDA, Agniveer, TES',
    slug:'defence-career',
    shortDescription:'Join the armed forces after 12th via NDA, Agniveer and TES entry schemes.',
    fullContent:'<p>The armed forces offer prestigious careers open to 12th-pass candidates.</p>'+
      '<h2>Entries</h2><ul><li>NDA (after 12th, via UPSC + SSB).</li>'+
      '<li>Agniveer (Army/Navy/Air Force recruitment).</li><li>TES (Technical Entry for PCM students).</li></ul>'+
      '<h2>Preparation</h2><p>Build fitness, academics and personality; SSB tests officer-like qualities.</p>'+
      info('Only use official indianarmy.nic.in / airforce/navy recruitment sites.') });
  ...
  add({ type:'article', category:'sports-pe', topic:'sports-quota',
  ...
  add({ type:'article', category:'sports-pe', topic:'coaching-career',
